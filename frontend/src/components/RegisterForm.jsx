...
function RegisterForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // 3️⃣ Salvar token no localStorage
      localStorage.setItem('token', loginData.token);

      setSuccess('Cadastro e login realizados com sucesso!');
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <TextField
                      ...
                      InputProps={{ startAdornment: <CpfIcon sx={{ color: 'action.active', mr: 1 }} /> }}
                      variant="outlined"
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <TextField
                      ...
                      InputProps={{ startAdornment: <CrnIcon sx={{ color: 'action.active', mr: 1 }} /> }}
                      variant="outlined"
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  InputProps={{ startAdornment: <LockIcon sx={{ color: 'action.active', mr: 1 }} /> }}
                  variant="outlined"
                />
              )}
            />
